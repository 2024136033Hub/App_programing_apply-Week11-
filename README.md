...
※ 잔디의 여부는 로그인 상태에서는 잔디가 잘 뜨지만 로그아웃 상태에서 접속 시 잔디가 다 심어지지 않은 화면으로 나와서 발표날 스크린샷을 찍어 root쪽에 jpg형태의 파일로 추가했습니다. 조작이나 그런게 아니라고 증명하기위해 찍은 시간까지 포함하여 스크린샷을 촬영했습니다.
---
